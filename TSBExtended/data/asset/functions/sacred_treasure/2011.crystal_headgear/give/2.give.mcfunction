#> asset:sacred_treasure/2011.crystal_headgear/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:sacred_treasure/2011.crystal_headgear/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:sacred_treasure/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:sacred_treasure ID set value 2011
# 神器のベースアイテム
    data modify storage asset:sacred_treasure Item set value "minecraft:leather_helmet"
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"水晶の頭飾り","color":"#00AACC","italic":false}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"謎の水晶で作られた頭飾り。"}','{"text":"妖しい光を放っている。"}','{"text":"\\"其れは理を歪める写し鏡。\\"","color":"gray"}']
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:sacred_treasure CustomNBT set value {display:{color:43724},HideFlags:100}
