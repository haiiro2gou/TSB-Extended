...
execute as @a[scores={1K3.Tick=1..},predicate=!lib:is_sneaking] run function asset:sacred_treasure/2019.multitool_stick/trigger/keep_sneak/reset
execute as @a[scores={1K3.Tick=..0}] run function asset:sacred_treasure/2019.multitool_stick/trigger/keep_sneak/reset
