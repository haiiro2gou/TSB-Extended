#> asset:sacred_treasure/2025.multitool_empty/trigger/fuel/wooden_trapdoors
#
# 所持チェック
#
...
# 処理
    execute store success score $1K9.Succeed Temporary run clear @s #wooden_trapdoors 1
