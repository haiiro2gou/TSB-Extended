...
# 神器の名前 (TextComponentString)
    data modify storage asset:sacred_treasure Name set value '{"text":"水晶の脚甲","color":"#00AACC","italic":false}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:sacred_treasure Lore set value ['{"text":"謎の水晶で作られた脚甲。"}','{"text":"身を十分に守れる堅さがある。"}','{"text":"\\"其れは歪みを増幅する畏れ。\\""}']
