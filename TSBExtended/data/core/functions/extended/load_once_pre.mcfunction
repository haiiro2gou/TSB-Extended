...
# TSB-patcherの後にロードするように
    ...
    execute unless data storage global Patcher.Version run datapack disable "file/TSBExtended"
    execute unless data storage global Patcher.Version run datapack enable "file/TSBExtended" after "file/TSB-Patcher"
