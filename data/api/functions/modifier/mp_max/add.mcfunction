...
# MPを調整
    ...
    # scoreboard players operation $DiffMP Temporary *= $100 Const
    ...
    # execute store result storage api: Argument.MP double 0.01 run scoreboard players get $DiffMP Temporary
    # function api:mp/set
# リセット
