...
# TSBの後にロードするように
    ...
    execute if data storage global Patcher.Version unless data storage global {Patcher:{Version:"v0.1.0"}} run tellraw @a [{"storage":"global","nbt":"Prefix.ERROR"},{"text":"TSB-Patcher v0.1.0を適用してください。","color":"white"}]
