...
# TSB-patcherの後にロードするように
    ...
    execute if data storage global {GameVersion:"v0.1.6",Patcher:{Version:"v0.0.2"}} run function core:extended/load_once
    ...
    execute if data storage global Patcher.Version unless data storage global {Patcher:{Version:"v0.0.2"}} run tellraw @a [{"storage":"global","nbt":"Prefix.ERROR"},{"text":"TSB-Patcher v0.0.2を適用してください。","color":"white"}]
