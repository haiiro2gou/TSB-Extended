...
# TSB-patcherの後にロードするように
    ...
    execute if data storage global {GameVersion:"v0.1.6",Patcher:{Version:"v0.0.4-alpha"}} run function core:extended/load_once
    ...
    execute if data storage global Patcher.Version unless data storage global {Patcher:{Version:"v0.0.4-alpha"}} run tellraw @a [{"storage":"global","nbt":"Prefix.ERROR"},{"text":"TSB-Patcher v0.0.4-alphaを適用してください。","color":"white"}]