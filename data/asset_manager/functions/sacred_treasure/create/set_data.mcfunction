...
# 使用回数(デフォルト)
    execute unless data storage asset:sacred_treasure RemainingCountMAX run data modify storage asset:sacred_treasure RemainingCountMAX set from storage asset:sacred_treasure RemainingCount
# そのまま入れれるやつ
    ...
    data modify storage asset:sacred_treasure Item.tag.TSB.RemainingCountMAX set from storage asset:sacred_treasure RemainingCountMAX
    ...
    data modify storage asset:sacred_treasure Item.tag.TSB.TSBE set from storage asset:sacred_treasure DataExtension
