...
# 処理済み配列に追加する
    ...
    execute if entity @s[tag=ClearEffect] if data storage asset:effect TargetEffect{RequireClearLvWithAPI:"weak"} run data remove storage asset:effect NextTickEffects[-1]
