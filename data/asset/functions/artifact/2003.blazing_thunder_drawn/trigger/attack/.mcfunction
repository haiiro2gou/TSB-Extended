#> asset:artifact/2003.blazing_thunder_drawn/trigger/attack/
#
# 攻撃処理
#
...
# ダメージ
    ...
    # 範囲化
        execute at @e[type=#lib:living,type=!player,tag=Victim,distance=..4] run function asset:artifact/2003.blazing_thunder_drawn/trigger/attack/range
    # 数値を代入
