#> asset:artifact/2010.peeping_goggles/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/2010.peeping_goggles/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 2010
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:leather_helmet"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"覗き見ゴーグル","color":"#a1cff4","italic":false}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"ほんの少し後の未来を覗き見ることができるゴーグル。"}','{"text":"\\"深淵をのぞく時、深淵もまたこちらをのぞいているのだ。\\"","color":"dark_red"}']
