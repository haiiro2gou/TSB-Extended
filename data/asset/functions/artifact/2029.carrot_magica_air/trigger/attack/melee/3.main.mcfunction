#> asset:sacred_treasure/2029.carrot_magica_air/trigger/attack/melee/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/2029.carrot_magica_air/trigger/attack/melee/2.check_condition
