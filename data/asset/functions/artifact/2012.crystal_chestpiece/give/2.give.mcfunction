#> asset:artifact/2012.crystal_chestpiece/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/2012.crystal_chestpiece/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 2012
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:leather_chestplate"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"水晶の胸当て","color":"#FCF3FF","italic":false}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"謎の水晶で作られた胸当て。"}','{"text":"見た目に反して壊れにくい。"}','{"text":"\\"其れは魔力を歪める呪い。\\"","color":"gray"}']
