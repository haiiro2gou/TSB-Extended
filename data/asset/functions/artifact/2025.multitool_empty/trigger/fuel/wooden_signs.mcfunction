#> asset:artifact/2025.multitool_empty/trigger/fuel/wooden_signs
#
# 所持チェック
#
...
# 処理
    execute store success score $1K9.Succeed Temporary run clear @s #asset:artifact/2025.multitool_empty/fuel/wooden_signs 1
