#> asset:artifact/2032.carrot_magica_dark/trigger/attack/melee/3.main
#
# 神器のメイン処理部
#
# @within function asset:artifact/2032.carrot_magica_dark/trigger/attack/melee/2.check_condition
