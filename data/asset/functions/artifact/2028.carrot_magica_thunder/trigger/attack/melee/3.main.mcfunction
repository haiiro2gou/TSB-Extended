#> asset:artifact/2028.carrot_magica_thunder/trigger/attack/melee/3.main
#
# 神器のメイン処理部
#
# @within function asset:artifact/2028.carrot_magica_thunder/trigger/attack/melee/2.check_condition
