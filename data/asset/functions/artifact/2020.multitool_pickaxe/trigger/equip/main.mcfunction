...
# メイン処理
    ...
    execute if score $1K4.Count Temporary matches 1.. store result storage asset:artifact Field.EquipCount int 1 run scoreboard players get $1K4.Count Temporary
