...
# tag check
    ...
    execute if data storage asset:context id{offhand:2008} if score @s 1JS.OffTimer matches ..0 run function asset:artifact/2008.desert_eagle/trigger/2.check_condition
