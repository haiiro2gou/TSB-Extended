#> asset:artifact/2014.crystal_sabatons/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/2014.crystal_sabatons/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 2014
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:leather_boots"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"水晶の靴","color":"#FCF3FF","italic":false}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"謎の水晶で作られた靴。"}','{"text":"魔力が吸われる感覚がする。"}','{"text":"\\"其れは力を吸い尽くす機械。\\"","color":"gray"}']
