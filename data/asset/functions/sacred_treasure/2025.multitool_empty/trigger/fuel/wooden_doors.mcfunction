#> asset:sacred_treasure/2025.multitool_empty/trigger/fuel/wooden_doors
#
# 所持チェック
#
...
# 処理
    execute store success score $1K9.Succeed Temporary run clear @s #asset:sacred_treasure/2025.multitool_empty/fuel/wooden_doors 1
