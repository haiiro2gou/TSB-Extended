#> asset:sacred_treasure/2008.desert_eagle/trigger/3.1.bullet
#
# 再起する弾
#
# @within function
#   asset:sacred_treasure/2008.desert_eagle/trigger/*/
#   asset:sacred_treasure/2008.desert_eagle/trigger/3.1.bullet
...
# 着弾
    execute if entity @s[tag=1JS.Landing] run function asset:sacred_treasure/2008.desert_eagle/trigger/3.2.bullet_damage

# 再起
    execute positioned ^ ^ ^0.5 if entity @s[tag=!1JS.Landing,distance=..80] run function asset:sacred_treasure/2008.desert_eagle/trigger/3.1.bullet
