#> asset:mob/2003.frestchika_full_tuned/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/2003.frestchika_full_tuned/summon/1.trigger
...
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"Frestchika Full-tuned"}'
# 武器
...
# 体力 (double) (オプション)
    data modify storage asset:mob Health set value 45990
# 攻撃力 (double) (オプション)
...
# 属性倍率 // 1.0fで100% 最低でも25%は軽減されずに入る
    ...
    # 魔法倍率 (float) (オプション)
        data modify storage asset:mob Resist.Magic set value 0.3
    # 火倍率 (float) (オプション)
        data modify storage asset:mob Resist.Fire set value 0.7
    # 水倍率 (float) (オプション)
        data modify storage asset:mob Resist.Water set value 0.3
    # 雷倍率 (float) (オプション)
