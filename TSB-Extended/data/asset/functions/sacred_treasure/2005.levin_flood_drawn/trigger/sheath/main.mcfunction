#> asset:sacred_treasure/2005.levin_flood_drawn/trigger/sheath/main
#
# 納刀メイン処理
#
# @within function asset:sacred_treasure/2005.levin_flood_drawn/trigger/sheath/
...
# メイン処理
    ...
    # 納刀
        ...
        execute unless entity @s[tag=1JP.DisEquip,scores={1JP.Equipped=0}] run function api:sacred_treasure/give/from_id

# 連続納刀防止
    tag @s add 1JP.SheathCD
    schedule function asset:sacred_treasure/2005.levin_flood_drawn/trigger/sheath/schedule 2t replace
