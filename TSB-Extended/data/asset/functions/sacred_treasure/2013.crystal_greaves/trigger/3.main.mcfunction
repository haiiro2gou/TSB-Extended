...
# 2012があるなら補正
    ...
    execute if data storage asset:context id.all{chest:2012} run function api:modifier/mp_max/add
    ...
    execute if data storage asset:context id.all{chest:2012} run function api:modifier/attack/magic/add
