#> asset:sacred_treasure/2031.carrot_magica_light/trigger/attack/melee/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/2031.carrot_magica_light/trigger/attack/melee/2.check_condition
