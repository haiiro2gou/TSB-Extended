#> asset:sacred_treasure/2025.multitool_empty/trigger/fuel/cartography_table
#
# 所持チェック
#
...
# 処理
    execute store success score $1K9.Succeed Temporary run clear @s cartography_table 1
